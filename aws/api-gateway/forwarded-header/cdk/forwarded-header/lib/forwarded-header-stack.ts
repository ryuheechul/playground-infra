...
import { HttpApi, HttpRoute, HttpRouteKey } from '@aws-cdk/aws-apigatewayv2-alpha';
...
export class ForwardedHeaderStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const integration = new HttpUrlIntegration('postman-echo', 'https://postman-echo.com/get');
